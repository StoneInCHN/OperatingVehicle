...
public class MetaRelation extends BaseEntity
{
   ...
   * 关系类型
   */
  private com.ov.entity.commonenum.CommonEnum.MetaRelation metaRelation;
  ...
  public com.ov.entity.commonenum.CommonEnum.MetaRelation getMetaRelation ()
  {
    return metaRelation;
  }

  public void setMetaRelation (
      com.ov.entity.commonenum.CommonEnum.MetaRelation metaRelation)
  {
