		...
		<div class="easyui-panel" data-options="fit:true,border:false">
			...
			<div id="systemConfig_manager_tool">
				<div class="tool-button">
					<a href="javascript:void(0);"  class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="systemConfig_manager_tool.add();">${message("csh.button.add")}</a>
					<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="systemConfig_manager_tool.edit();">${message("csh.button.update")}</a>
					<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true" plain=true onclick="systemConfig_manager_tool.remove();">${message("csh.button.delete")}</a>
				</div>
				    	...
				    	<tr>
				    		...
				    		<td>
			    			  <select id="isEnabled" class="easyui-combobox" name="isEnabled" style="width:45px;" data-options="panelMaxHeight:55">   
								<option value="true">${message("csh.common.yes")}</option>
								<option value="false">${message("csh.common.no")}</option> 
							  </select>  
	    					</td>
				    	</tr>
