...
<div>
	  <fieldset>
	    <legend>角色查询</legend>
	    <form id="common-role-search-form" class="search-form">
		...
		<div class="search-item">
	  	  <button id="common-role-search-btn" class="easyui-linkbutton" data-options="iconCls:'icon-search'">${message("ov.search")}</button>
	    </div>
	  </fieldset>
</div>
