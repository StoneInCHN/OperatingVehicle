...
<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'west',split:true" style="width:250px" title="车辆查询">
			<fieldset style="padding:5px 0px 4px 4px;margin:0px">
			        <form id="oilCharge_vehicle_search_form" class="search-form">
					...
					<div class="search-item">
				  	  <button id="oilCharge_vehicle_search_btn" class="easyui-linkbutton" style="margin-left:2px;margin-right:2px"data-options="iconCls:'icon-search'">${message("ov.search")}</button>
				    </div>
				</fieldset>
                <table id="oilChargeVehicleSearch-table-list"></table>
		</div>
				...
				<div class="easyui-panel" style="height:800px;background:#fafafa;" data-options="border:false">
						  <fieldset>
								    ...
								    <form id="oilChargeReport_search_form" class="search-form">
										...
										<input type="hidden" name="vehicleID" id="oilCharge_vehicleID">
									</form>
									<div class="search-item">
