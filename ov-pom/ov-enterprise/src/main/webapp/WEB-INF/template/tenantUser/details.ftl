	 ...
	 <input type="hidden" id="addTenantUser_form_file_input" name="photo"> 
	    <table class="table table-striped"  border="0">
	    	...
	    	<tr>
	    		...
	    		<td>
	    			 <input class="easyui-combobox" disabled="disabled" id="tenantUserDepartment-detail" name="departmentId" data-options="prompt:'${message("ov.common.please.select")}'" value="${tenantUser.department.name}"/>   
	    		</td>
	    	
	    		<th>${message("ov.tenantUser.position")}:</th>
	    		<td>
	    			 <input class="easyui-combobox"  disabled="disabled" type="text" id="tenantUserPosition-detail" name="positionId" id="position" data-options="prompt:'${message("ov.common.please.select")}'" value="${tenantUser.position.name}"/>
	    		</td>
	    	</tr>
	    	<tr>
