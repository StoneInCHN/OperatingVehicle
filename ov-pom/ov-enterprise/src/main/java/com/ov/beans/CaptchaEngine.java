...
public class CaptchaEngine extends ListImageCaptchaEngine {
  ...
  private static final Color[] COLORS = new Color[] {new Color(255, 255, 255),
      new Color(255, 220, 220), new Color(220, 255, 255), new Color(220, 220, 255),
  ...
  protected void buildInitialFactories() {
    ...
    BackgroundGenerator backgroundGenerator =
        new FileReaderRandomBackgroundGenerator(IMAGE_WIDTH, IMAGE_HEIGHT, new ClassPathResource(
    ...
    addFactory(new GimpyFactory(new RandomWordGenerator(CHAR_STRING), new ComposedWordToImage(
