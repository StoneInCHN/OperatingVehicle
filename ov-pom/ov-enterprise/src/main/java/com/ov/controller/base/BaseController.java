package com.ov.controller.base;
...
import com.ov.beans.DateEditor;
import com.ov.beans.Message;
import com.ov.utils.DateTimeUtils;
import com.ov.utils.ExportExcel;
...
public class BaseController {
  ...
  /** 错误消息 */
  protected static final Message ERROR_MESSAGE = Message.error("ov.message.error");

  /** 成功消息 */
  protected static final Message SUCCESS_MESSAGE = Message.success("ov.message.success");
