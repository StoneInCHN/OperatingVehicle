...
public class UpkeepChargeReportController extends BaseController {
  ...
  public @ResponseBody List<UpkeepChargeReport> list(Model model, Pageable pageable
    ...
    Ordering dateCycleOrdering = new Ordering ("upkeepChargeStatiticsDate",
        Direction.desc);
    ...
    if (beginDate != null)
    {
      ...
      startDateFilter.setProperty ("upkeepChargeStatiticsDate");
    ...
    if (endDate != null)
    {
      ...
      endDateFilter.setProperty ("upkeepChargeStatiticsDate");
    ...
    ReportDataComparator comparator =new ReportDataComparator ("upkeepChargeStatiticsDate");
