...
public class OilChargeServiceImpl extends BaseServiceImpl<OilCharge,Long> implements OilChargeService {
      ...
      @Resource(name = "oilChargeDaoImpl")
      private OilChargeDao oilChargeDao;

      @Override
      public Page<OilCharge> findPageByFilter(String vehiclePlateSearch, Date beginDate,
        ...
        try {
          ...
          return oilChargeDao.search(query, pageable, analyzer, null);
        } catch (Exception e) {
          e.printStackTrace();
        }
        return null;
