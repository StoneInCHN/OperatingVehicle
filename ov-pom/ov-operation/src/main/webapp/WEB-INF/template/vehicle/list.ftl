...
<head>
<title>${message("ov.vehicle.list")}</title>
...
<div class="mainbar">
				<div class="page-head">
					<div class="bread-crumb">
						...
						<span  class="bread-current"><i class="fa fa-list"></i>${message("ov.vehicle.list")}(${message("ov.page.total", page.total)})</span>
					</div>
			              ...
			              <div class="col-md-12">
			                <div class="widget">
									 <div class="widget-head">
						                  <div class="pull-left"><i class="fa fa-list"></i>${message("ov.main.vehicle")}</div>
						              ...
						              <div class="widget-content">
										<table id="listTable" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
													<th>
														<a href="javascript:;" class="sort" name="plate">${message("ov.vehicle.plate")}</a>
													</th>
													<th>
														<a href="javascript:;" class="sort" name="vehicleNo">${message("ov.vehicle.vehicleNo")}</a>
													</th>
													<th>
													...
													<th>
														<a href="javascript:;" class="sort" name="produceDate">${message("ov.vehicle.produceDate")}</a>
													</th>
													<th>
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<a href="details.jhtml?id=${vehicle.id}" title="${message("ov.common.edit")}"><i class="fa fa-eye"></i></a>
													</td>
												</tr>
											</tbody>
											[/#list]
