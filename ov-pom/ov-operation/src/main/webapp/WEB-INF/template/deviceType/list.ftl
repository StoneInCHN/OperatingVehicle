...
<head>
<title>${message("ov.deviceType.list")}</title>
...
<div class="mainbar">
				<div class="page-head">
					<div class="bread-crumb">
						...
						<span  class="bread-current"><i class="fa fa-list"></i>${message("ov.deviceType.list")}(${message("ov.page.total", page.total)})</span>
					</div>
						  		...
						  		<div class="input-group">
								      <div class="input-group-btn">
								        ...
								        <ul class="dropdown-menu menuWrap" id="searchPropertyOption" role="menu">
								          <li [#if page.searchProperty == "name" || page.searchProperty ==null] selected="selected" class="active" [/#if] title="name"><a href="#">${message("ov.deviceType.name")}</a></li>
								        </ul>
								      </div>
			              ...
			              <div class="col-md-12">
			                <div class="widget">
									 <div class="widget-head">
						                  <div class="pull-left"><i class="fa fa-list"></i>${message("ov.main.deviceType")}</div>
										...
										<table id="listTable" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
													...
													<th>
														<a href="javascript:;" class="sort" name="name">${message("ov.deviceType.name")}</a>
													</th>

													<th>
														<a href="javascript:;" class="sort" name="accoutStatus">${message("ov.deviceType.status")}</a>
													</th>
													<th>
											...
											<tbody>
												...
												<tr>
													...
													<td>
														${message("ov.deviceType.status."+deviceType.status)}
													</td>
													<td>
														<a href="edit.jhtml?id=${deviceType.id}" title="${message("ov.common.edit")}"><i class="fa fa-pencil-square-o"></i></a>
													</td>
												</tr>
											</tbody>
											[/#list]
