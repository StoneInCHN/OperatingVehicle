						  		...
						  		<div class="input-group">
								      <div class="input-group-btn">
								        ...
								        <ul class="dropdown-menu menuWrap" id="searchPropertyOption" role="menu">
								          <li [#if page.searchProperty == "orgCode" ] selected="selected" class="active" [/#if] title="orgCode"><a href="#">${message("ov.tenantInfo.orgCode")}</a></li>
								          ...
								          <li [#if page.searchProperty == "contactPhone" ] selected="selected" class="active" [/#if] title="contactPhone"><a href="#">${message("ov.tenantInfo.contactPhone")}</a></li>
								          <li [#if page.searchProperty == "contactPerson" ] selected="selected" class="active" [/#if] title="contactPerson"><a href="#">${message("ov.tenantInfo.contactPerson")}</a></li>
								        </ul>
								      </div>
										...
										<table id="listTable" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
													...
													<th>
														<a href="javascript:;" class="sort" name="orgCode">${message("ov.tenantInfo.orgCode")}</a>
													</th>
													<th>
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<a href="edit.jhtml?id=${tenantInfo.id}" title="${message("ov.common.edit")}"><i class="fa fa-pencil-square-o"></i></a>
													</td>
												</tr>
												[/#list]
											</tbody>
