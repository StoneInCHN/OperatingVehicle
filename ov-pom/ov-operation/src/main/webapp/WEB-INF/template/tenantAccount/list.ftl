...
<head>
<title>${message("ov.tenantAccount.list")}</title>
...
<div class="mainbar">
				<div class="page-head">
					<div class="bread-crumb">
						...
						<span  class="bread-current"><i class="fa fa-list"></i>${message("ov.tenantAccount.list")}(${message("ov.page.total", page.total)})</span>
					</div>
						  		...
						  		<div class="input-group">
								      <div class="input-group-btn">
								        ...
								        <ul class="dropdown-menu menuWrap" id="searchPropertyOption" role="menu">
								          <li [#if page.searchProperty == "userName"] selected="selected" class="active" [/#if] title="userName"><a href="#">${message("ov.tenantAccount.userName")}</a></li>
										   <li [#if page.searchProperty == "realName" ] selected="selected" class="active" [/#if] title="realName"><a href="#">${message("ov.tenantAccount.realName")}</a></li>
								        </ul>
								      </div>
			              ...
			              <div class="col-md-12">
			                <div class="widget">
									 <div class="widget-head">
						                  <div class="pull-left"><i class="fa fa-list"></i>${message("ov.main.tenantAccount")}</div>
										...
										<table id="listTable" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
													...
													<th>
														<a href="javascript:;" class="sort" name="username">${message("ov.tenantAccount.userName")}</a>
													</th>
													<th>
														<a href="javascript:;" class="sort" name="realName">${message("ov.tenantAccount.realName")}</a>
													</th>
													<th>
														<a href="javascript:;" class="sort" name="loginDate">${message("ov.tenantAccount.loginDate")}</a>
													</th>
													<th>
														<a href="javascript:;" class="sort" name="loginIp">${message("ov.tenantAccount.loginIp")}</a>
													</th>
													<th>
														<a href="javascript:;" class="sort" name="createDate">${message("ov.common.createDate")}</a>
													</th>
													<th>
														<a href="javascript:;" class="sort" name="accoutStatus">${message("ov.tenantAccount.accoutStatus")}</a>
													</th>
													<th>
											...
											<tbody>
												[#list page.content as tenantAccount]
												<tr>
													<td>
													...
													<td>
														[#if tenantAccount.accoutStatus??]
															${message("ov.tenantAccount.accoutStatus."+tenantAccount.accoutStatus)}
														[/#if]
													</td>
													<td>
														<a href="edit.jhtml?id=${tenantAccount.id}" title="${message("ov.common.edit")}"><i class="fa fa-pencil-square-o"></i></a>
													</td>
												</tr>
											</tbody>
											[/#list]
