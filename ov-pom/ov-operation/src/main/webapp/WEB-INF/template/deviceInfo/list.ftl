...
<div class="mainbar">
				<div class="page-head">
					<div class="bread-crumb">
						...
						<span  class="bread-current"><i class="fa fa-list"></i>${message("ov.deviceInfo.list")}(${message("ov.page.total", page.total)})</span>
					</div>
						  ...
						  <div class="col-xs-9 col-md-9 col-lg-9">
						  		<ul class="nav">
									 <li class="pull-left">
										...
										<div class="btn-group operationButton">
										  <button type="button" id="batchdAddButton" class="btn btn-default"><i class="fa fa-plus"></i>&nbsp;&nbsp;${message("ov.deviceInfo.batchAdd")}</button>
										</div>
										<div class="btn-group operationButton">
									  ...
									  <li role="presentation" class="dropdown pull-right">
										...
										<li role="presentation" class="dropdown pull-right ">
											...
											<ul id="filterOption" class="dropdown-menu" role="menu" aria-labelledby="filterSelect">
												...
												<li>
													<a href="javascript:;" name="deviceStatus" val="INITED" [#if deviceStatus == "INITED"] class="checked"[/#if]>${message("ov.deviceInfo.deviceStatus.INITED")}</a>
												</li>
												<li>
						  		...
						  		<div class="input-group">
								      <div class="input-group-btn">
								        ...
								        <ul class="dropdown-menu menuWrap" id="searchPropertyOption" role="menu">
								          <li [#if page.searchProperty == "deviceNo" ] selected="selected" class="active" [/#if] title="deviceNo"><a href="#">${message("ov.deviceInfo.deviceNo")}</a></li>
								           <li [#if page.searchProperty == "simNo" ] selected="selected" class="active" [/#if] title="simNo"><a href="#">${message("ov.deviceInfo.simNo")}</a></li>
								        </ul>
								      </div>
										...
										<table id="listTable" class="table table-striped table-bordered table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<a href="edit.jhtml?id=${deviceInfo.id}" title="${message("ov.common.edit")}"><i class="fa fa-pencil-square-o"></i></a>
